...
_BUILTIN_SHORTCUTS: Tuple[ShortcutDefinition, ...] = (
    ...
    ShortcutDefinition("toggle_project_tree", "显示/隐藏项目树", "Alt+1", "界面控制", ("导航",)),
    ShortcutDefinition("toggle_extension_panel", "显示/隐藏扩展面板", "Alt+2", "界面控制", ("导航",)),
    ShortcutDefinition("go_home", "回到主页", "Alt+H", "界面控制", ("导航",)),
    ShortcutDefinition("go_data_page", "打开数据管理", "Alt+D", "界面控制", ("导航",)),
    ShortcutDefinition("go_chart_page", "打开数据可视化", "Alt+V", "界面控制", ("导航",)),
    ShortcutDefinition("go_process_page", "打开数据处理", "Alt+P", "界面控制", ("导航",)),
    ShortcutDefinition("go_analysis_page", "打开数据分析", "Alt+A", "界面控制", ("导航",)),
    ShortcutDefinition("go_digitize_page", "打开图片数字化", "Alt+G", "界面控制", ("导航",)),
    ShortcutDefinition("go_settings_page", "打开设置", "Alt+S", "界面控制", ("导航",)),
    ...
    ShortcutDefinition("data_delete_node", "删除节点", "Shift+Delete", "数据管理", ("编辑", "节点")),
    ...
    ShortcutDefinition("undo", "撤销", "Ctrl+Z", "图片数字化", ("编辑",)),
    ShortcutDefinition("redo", "重做", "Ctrl+Y", "图片数字化", ("编辑",)),
    ShortcutDefinition("add_image", "添加图片", "Ctrl+I", "图片数字化", ("导入",)),
    ShortcutDefinition("add_curve", "添加曲线", "Ctrl+Shift+N", "图片数字化", ("曲线",)),
    ShortcutDefinition("extract", "手动提取模式", "Q", "图片数字化", ("工具",)),
    ShortcutDefinition("calibrate", "校准模式", "C", "图片数字化", ("工具",)),
    ShortcutDefinition("eraser", "橡皮擦模式", "E", "图片数字化", ("工具",)),
    ShortcutDefinition("auto_detect", "自动检测", "A", "图片数字化", ("工具",)),
    ShortcutDefinition("apply_auto", "应用检测结果", "Ctrl+Return", "图片数字化", ("工具",)),
    ShortcutDefinition("clear_points", "清除所有点", "Ctrl+Delete", "图片数字化", ("清理",)),
    ShortcutDefinition("clear_masks", "清除蒙版", "Ctrl+Shift+Delete", "图片数字化", ("清理",)),
    ShortcutDefinition("escape_tool", "取消当前工具", "Escape", "图片数字化", ("工具",)),
    ShortcutDefinition("zoom_in", "放大", "Ctrl+=", "图片数字化", ("缩放", "视图")),
    ShortcutDefinition("zoom_out", "缩小", "Ctrl+-", "图片数字化", ("缩放", "视图")),
    ShortcutDefinition("zoom_fit", "适合窗口", "Ctrl+0", "图片数字化", ("缩放", "视图")),
    ShortcutDefinition("delete_rows", "删除数据行", "Delete", "图片数字化", ("表格", "编辑")),
)
