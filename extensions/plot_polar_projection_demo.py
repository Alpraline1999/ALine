    ...
    registry.register_plot(
        PlotExtension(
            ...
            default_options={
                ...
                "alpha": 0.95,
                "fill_alpha": 0.0,
                "radial_label_angle": None,
            },
            config_fields=[
                ExtensionConfigField(key="theta_unit", description="角度数据单位。", field_type="string", default="degree", choices=("degree", "radian")),
                ...
                ExtensionConfigField(key="zero_location", description="极坐标零角方向。", field_type="string", default="N", choices=("N", "E", "S", "W")),
                ExtensionConfigField(key="direction", description="角度增长方向。", field_type="string", default="counterclockwise", choices=("counterclockwise", "clockwise")),
                ...
                ExtensionConfigField(key="fill_alpha", description="填充透明度；0 表示不填充。", field_type="number", default=0.0),
            ],
        )
    )