...
class TestPhase10Guardrails(unittest.TestCase):
    ...
    def test_project_tree_global_extension_menu_executes_with_position_and_callbacks(self) -> None:
        ...
        builder = ProjectTreeMenuBuilder(
            ...
            _cmd_import_global_assets=lambda *args, **kwargs: None,
            _cmd_export_global_asset=lambda *args, **kwargs: None,
            ...
            save_current_project=lambda *args, **kwargs: None,
            save_current_project_as=lambda *args, **kwargs: None,
            close_current_project=lambda *args, **kwargs: None,
